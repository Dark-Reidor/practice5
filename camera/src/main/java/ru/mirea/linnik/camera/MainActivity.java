package ru.mirea.linnik.camera;
...
public class MainActivity extends AppCompatActivity {
    ...
    /**
    Данный код запустит приложение, работающее с камерой, позволяя
    пользователю поменять настройки изображения, что освобождает разработчиков от
    необходимости создавать своё собственное приложение для этих нужд. Вполне
    возможно, что у пользователя будет установлено несколько приложений, умеющих
    делать фотографии, тогда сначала появится окно выбора программы.
